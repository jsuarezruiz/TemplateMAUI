...
{
    /// <summary>
    /// Provides animation handling for the appearance and disappearance of the Slider preview value.
    /// </summary>
    public class PreviewSliderAnimation : IPreviewSliderAnimation
    {
